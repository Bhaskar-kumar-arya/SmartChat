...
const botDir = path.join(__dirname, '../src/main/tests/extensions/fixtures/unread-summarizer-bot');
const outputPath = path.join(__dirname, '../src/main/tests/extensions/fixtures/unread-summarizer-bot.scext');

console.log('[Package Bot] Packaging unread-summarizer-bot...');
